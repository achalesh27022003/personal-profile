...
var _excluded = ["autoclose", "children", "id", "level", "open", "size", "x", "y", "onClose"];
...
var Menu = function Menu(_ref) {
  ...
  function handleClickOutside(event) {
    if (!(0, _utils.clickedElementHasSubnodes)(event) && open && canBeClosed && autoclose) {
      close(event.type);
    }
  }
  ...
  function handleBlur(event) {
    ...
    if (isRootMenu && !(rootRef !== null && rootRef !== void 0 && (_rootRef$current4 = rootRef.current) !== null && _rootRef$current4 !== void 0 && _rootRef$current4.element.contains(event.relatedTarget))) {
      close(event.type);
    }
  }
  ...
  (0, _react.useEffect)(function () {
    ...
    if (open) {
      ...
      if (isRootMenu) {
        var _rootRef$current5, _rootRef$current5$ele;

        rootRef === null || rootRef === void 0 ? void 0 : (_rootRef$current5 = rootRef.current) === null || _rootRef$current5 === void 0 ? void 0 : (_rootRef$current5$ele = _rootRef$current5.element) === null || _rootRef$current5$ele === void 0 ? void 0 : _rootRef$current5$ele.focus();
      } else {
        var _rootRef$current6;

        var parentMenu = (0, _utils.getParentMenu)(rootRef === null || rootRef === void 0 ? void 0 : (_rootRef$current6 = rootRef.current) === null || _rootRef$current6 === void 0 ? void 0 : _rootRef$current6.element);
  ...
  var menu = /*#__PURE__*/_react.default.createElement(_ClickListener.default, {
